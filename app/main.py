...
# from app.routers import survey, crosstab, comment_analysis, annotate, export, feishu, admin, settings_api, history
# for _r in (survey, crosstab, comment_analysis, annotate, export, feishu, admin, settings_api, history):
